...
import pw.wow.sbma.config.audit.AuditEventConverter;
import pw.wow.sbma.domain.PersistentAuditEvent;
...
import static pw.wow.sbma.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
