...
import pe.wow.sbma.domain.PersistentAuditEvent;
import pe.wow.sbma.AppApp;
import pe.wow.sbma.config.audit.AuditEventConverter;
...
import static pe.wow.sbma.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
