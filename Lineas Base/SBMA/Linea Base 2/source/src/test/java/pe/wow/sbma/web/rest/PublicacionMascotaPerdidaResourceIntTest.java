...
import static pe.wow.sbma.web.rest.TestUtil.sameInstant;
...
public class PublicacionMascotaPerdidaResourceIntTest {
    ...
    public void setup() {
        ...
        final PublicacionMascotaPerdidaResource publicacionMascotaPerdidaResource = new PublicacionMascotaPerdidaResource(publicacionMascotaPerdidaService);
    ...
    public void updatePublicacionMascotaPerdida() throws Exception {
        // Initialize the database
        publicacionMascotaPerdidaService.save(publicacionMascotaPerdida);
