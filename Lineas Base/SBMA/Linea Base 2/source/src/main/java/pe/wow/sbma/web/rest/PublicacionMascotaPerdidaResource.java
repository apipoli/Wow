...
import pe.wow.sbma.service.PublicacionMascotaPerdidaService;
...
public class PublicacionMascotaPerdidaResource {
    ...
    private final PublicacionMascotaPerdidaService publicacionMascotaPerdidaService;

    public PublicacionMascotaPerdidaResource(PublicacionMascotaPerdidaService publicacionMascotaPerdidaService) {
        this.publicacionMascotaPerdidaService = publicacionMascotaPerdidaService;
    }
    ...
    public ResponseEntity<PublicacionMascotaPerdida> createPublicacionMascotaPerdida(@Valid @RequestBody PublicacionMascotaPerdida publicacionMascotaPerdida) throws URISyntaxException {
        ...
        PublicacionMascotaPerdida result = publicacionMascotaPerdidaService.save(publicacionMascotaPerdida);
    ...
    public ResponseEntity<List<PublicacionMascotaPerdida>> getAllPublicacionMascotaPerdidas(@ApiParam Pageable pageable) {
        ...
        Page<PublicacionMascotaPerdida> page = publicacionMascotaPerdidaService.findAll(pageable);
    ...
    public ResponseEntity<PublicacionMascotaPerdida> getPublicacionMascotaPerdida(@PathVariable Long id) {
        ...
        PublicacionMascotaPerdida publicacionMascotaPerdida = publicacionMascotaPerdidaService.findOne(id);
    ...
    public ResponseEntity<Void> deletePublicacionMascotaPerdida(@PathVariable Long id) {
        ...
        publicacionMascotaPerdidaService.delete(id);
